...
\title{
  \textbf{Contingency and Apotheosis \\ in Sartrean Metaphysics:} \\
  An Investigation into the Question of \\
  Whether Love and Philosophy are Possible
}
\author{
...
\include{sections/love.tex}

\include{sections/philosophy.tex}
